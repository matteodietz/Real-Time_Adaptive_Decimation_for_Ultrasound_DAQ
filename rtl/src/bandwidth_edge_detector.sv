module bandwidth_edge_detector #(
    ...
    output logic [POWER_WIDTH-1:0]      L1_left_o,      // Power at f1 (below threshold)
    output logic [POWER_WIDTH-1:0]      L2_left_o,      // Power at f2 (above threshold)
...
//     parameter int POWER_WIDTH = 8,
//     parameter int POWER_FRAC = 0,
//     parameter logic [POWER_WIDTH-1:0] THRESHOLD_DROP = 8'h1E, // 30dB in Q8.0
...
//     // Outputs: Left edge crossing points (BIN INDICES)
//     output logic [$clog2(NUM_BINS)-1:0] f1_left_o,      // Lower bin index
//     output logic [$clog2(NUM_BINS)-1:0] f2_left_o,      // Higher bin index
//     output logic [POWER_WIDTH-1:0]      L1_left_o,      // Power at f1 (below threshold)
//     output logic [POWER_WIDTH-1:0]      L2_left_o,      // Power at f2 (above threshold)
    
//     // Outputs: Right edge crossing points (BIN INDICES)
//     output logic [$clog2(NUM_BINS)-1:0] f1_right_o,     // Lower bin index
//     output logic [$clog2(NUM_BINS)-1:0] f2_right_o,     // Higher bin index
//     output logic [POWER_WIDTH-1:0]      L1_right_o,     // Power at f1 (above threshold)
//     output logic [POWER_WIDTH-1:0]      L2_right_o,     // Power at f2 (below threshold)
//     output logic [POWER_WIDTH-1:0]      abs_threshold_o,
...
//     // Assign outputs (now bin indices instead of frequencies)
//     assign f1_left_o  = f1_left;
//     assign f2_left_o  = f2_left;
//     assign L1_left_o  = L1_left;
//     assign L2_left_o  = L2_left;
