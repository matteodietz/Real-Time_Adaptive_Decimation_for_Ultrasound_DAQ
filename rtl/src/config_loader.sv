...
// //
// //  Description:
// //      AXI-Stream interface module for loading freq_steps configuration array
// //      into parallel registers. Receives freq_steps values serially via 
// //      AXI-Stream and stores them in internal registers for use by the main
// //      processing pipeline.
// //
// //  Protocol:
// //      - NUM_BINS transfers carry freq_steps values
// //      - After all values loaded, config_valid_o asserts
// //
// ////////////////////////////////////////////////////////////////////////////////
...
//     parameter integer PHASE_WIDTH = 16,
//     parameter integer NUM_BINS = 24,
//     parameter integer DATA_WIDTH = 16  // Should match PHASE_WIDTH
// )(
//     input  logic clk_i,
//     input  logic rst_ni,
...
//     localparam integer COUNTER_WIDTH = $clog2(NUM_BINS + 1);
...
//                     // Check if we've received all freq_steps
//                     if (transfer_count_q == COUNTER_WIDTH'(NUM_BINS - 1)) begin
//                         state_d = DONE;
//                         transfer_count_d = '0;
//                         config_valid_d = 1'b1;
//                     end else begin
