...
//     // --- Pipeline Stage 2: Complex Multiplication + Bin Index Registration ---
...
//     // Register the bin indices along with multiplication results
//     logic [COUNTER_WIDTH-1:0] prod_bin_0_q, prod_bin_0_d;
//     logic [COUNTER_WIDTH-1:0] prod_bin_1_q, prod_bin_1_d;
...
//     // -------------------------------------------------------------------------
//     // Combinational Logic: Stage 2 (Complex Mult with streaming oscillators)
//     // -------------------------------------------------------------------------
//     always_comb begin
...
//             // Complex multiplication using streaming oscillator outputs
//             // NO array indexing - use streaming values directly!
...
//             xr_wr_0 = x_weighted_real_q * cos_out_0;
//             xi_wi_0 = x_weighted_imag_q * sin_out_0;
//             xr_wi_0 = x_weighted_real_q * sin_out_0;
//             xi_wr_0 = x_weighted_imag_q * cos_out_0;
            
//             prod_real_d[0] = xr_wr_0 - xi_wi_0;
//             prod_imag_d[0] = xr_wi_0 + xi_wr_0;
            
//             // CORDIC_1 outputs (bin1)
//             xr_wr_1 = x_weighted_real_q * cos_out_1;
//             xi_wi_1 = x_weighted_imag_q * sin_out_1;
//             xr_wi_1 = x_weighted_real_q * sin_out_1;
//             xi_wr_1 = x_weighted_imag_q * cos_out_1;
            
//             prod_real_d[1] = xr_wr_1 - xi_wi_1;
//             prod_imag_d[1] = xr_wi_1 + xi_wr_1;
            
//             // Register bin indices along with products
//             prod_bin_0_d = output_bin_0;
//             prod_bin_1_d = output_bin_1;
...
//                     // Use registered bin indices directly - no computation needed!
//                     // This eliminates the critical timing path
