...
//     logic osc_reset_internal;       // Oscillator reset pulse from timing controller
...
//         .osc_reset_o        (osc_reset_internal),       // Oscillator reset pulse
//         .dft_sample_valid_o (dft_sample_valid_internal) // Sample valid during DFT window
//     );
...
//     // Gate the input sample_valid with the DFT window
...
//         .sample_valid_i     (sample_valid_gated),        // Use gated sample valid
//         .last_sample_i      (last_sample_internal),      // Use internal signal from timing controller
        
//         // Oscillator Control
//         .osc_reset_i        (osc_reset_internal),   // Reset from timing controller (before osc starts)
...
//
//  Description:
//      Complete pipeline for spectral power estimation. Wraps the counter
