module spectral_power_estimator_tmux #(
    ...
    parameter integer ACCUM_WIDTH_FRAC = 38,
    ...
    parameter integer POWER_INPUT_WIDTH = 18,     // Width after clipping accumulator
    ...
    parameter integer OSC_LATENCY = 20,           // CORDIC pipeline depth
    ...
    // =========================================================================
    // Take upper bits from 36-bit accumulators to feed into power converters
    ...
    complex_to_log_power_tmux #(
        ...
        .LATENCY            (5)  // Fixed 5-cycle latency
    ) u_log_power_tmux (
        .clk_i              (clk_i),
        .rst_ni             (rst_ni),
        .valid_i            (dft_valid),
