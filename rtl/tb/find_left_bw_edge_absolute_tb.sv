module find_bw_left_edge_absolute_tb ();
    ...
    localparam logic [ACCUM_WIDTH-1:0] FORCED_THRESHOLD = 18'h01E00;
    ...
    logic [ACCUM_WIDTH-1:0]          abs_threshold_stim;
    
    logic        [FREQ_BIN_WIDTH-1:0] act_f1, act_f2;
    logic [ACCUM_WIDTH-1:0]          act_L1, act_L2;
    logic                            act_valid;
    logic                            act_busy;
    ...
    initial begin: checker_block
        ...
        abs_threshold_stim = FORCED_THRESHOLD;
