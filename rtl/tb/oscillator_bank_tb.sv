...
module oscillator_bank_tb;
    ...
    initial begin
        ...
        $display("=============================================================");
        $display("Bin 0 freq_step: 0x%08h (completes ~4 full cycles in 1024 clocks)", freq_steps[0]);
        $display("Bin 1 freq_step: 0x%08h (completes ~2 full cycles in 1024 clocks)", freq_steps[1]);
