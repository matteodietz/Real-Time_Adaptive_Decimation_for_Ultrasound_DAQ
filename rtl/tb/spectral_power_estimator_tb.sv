module spectral_power_estimator_tb();
    ...
    initial begin: checker_block
        ...
        while (!$feof(file)) begin
            ...
            // If we didn't capture valid during streaming, something went wrong
            if (!valid_captured) begin
                $display("  ERROR: valid_o was never asserted during sample streaming");
                $display("  This likely means the DFT never completed");
                n_errs++;
