...
module top_with_config_loader_tb();
    ...
    initial begin: checker_block
        ...
        $display("=== Starting Top Module with Config Loader Testbench ===");
        
        // Build file paths
        vector_path = "/home/bsc25h10/mdietz/bachelors_thesis/rtl/simvectors/top_vectors.txt";
        csv_path = "/home/bsc25h10/mdietz/bachelors_thesis/rtl/sim_results/top_with_config_loader_results.csv";
        ...
        while (!$feof(file)) begin
            ...
            // Step 3: Stream all samples and watch for valid_o
            $display("  Streaming %0d samples (respecting dft_ready)...", num_samples_read);
