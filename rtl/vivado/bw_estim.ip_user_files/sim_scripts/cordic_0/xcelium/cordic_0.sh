...
design_libs_elab="-libname xbip_utils_v3_0_14 -libname c_reg_fd_v12_0_10 -libname xbip_dsp48_wrapper_v3_0_6 -libname xbip_pipe_v3_0_10 -libname c_addsub_v12_0_19 -libname mult_gen_v12_0_22 -libname axi_utils_v2_0_10 -libname cordic_v6_0_23 -libname xil_defaultlib -libname secureip"
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/bsc25h10/mdietz/bachelors_thesis/rtl/vivado/bw_estim.cache/compile_simlib/xcelium"
  fi
