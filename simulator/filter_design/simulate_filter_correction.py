...
# ==============================================================================
# 6. Error Analysis (Input-Referred)
# ==============================================================================
...
print(f"Scenario A (Standard): {sqnr_A:.2f} dB")
print(f"Scenario B (Boosted):  {sqnr_B:.2f} dB")
print(f"Improvement:           {sqnr_B - sqnr_A:.2f} dB")
print(f"Effective Bits Gained: {(sqnr_B - sqnr_A)/6.02:.2f} bits")
...
# --- C. Amplitude Check ---
print(f"\n[Check] Plot Amplitude Logic:")
print(f"  Source Amp: 0.9")
print(f"  Channel Gain: {channel_gain_linear:.2f} (-6 dB)")
print(f"  Expected ADC Input Peak: 0.9 * {channel_gain_linear:.2f} = {0.9 * channel_gain_linear:.3f}")
print(f"  (This explains why the analog plot peaks at ~0.45)")
