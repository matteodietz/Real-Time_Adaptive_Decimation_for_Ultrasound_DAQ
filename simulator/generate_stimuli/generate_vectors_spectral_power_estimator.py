...
#                        window_number, hw_params, normalize=False, max_magnitude=1.0):
#     """
...
#     # IQ samples (full frame, 16-bit fixed point Q2.14)
#     i_samples_hw = []
#     q_samples_hw = []
#     for sample in baseline_iq_data:
#         i_val = float_to_fixed_point(sample.real, 2, 14, signed=True)
#         q_val = float_to_fixed_point(sample.imag, 2, 14, signed=True)
...
#         w_val = float_to_fixed_point(coeff, 2, 14, signed=True)
